...
| eMMC | Samsung eMMC 5.1, nominal 16 GB/observed 14.6 GiB, CID MID `0x15`, product name `AJTD4R`; confirmed 4-bit/1.8 V HS200; VCC is 3.3 V and VCCQ/I/O is fixed at 1.8 V | Model separate `vmmc` 3.3 V and `vqmmc` 1.8 V supplies; advertise four-bit HS200 only, keep HS400 disabled, and require a matching 200 MHz SoftPHY handoff |
