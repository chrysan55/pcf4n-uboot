...
| eMMC | Samsung eMMC 5.1, nominal 16 GB/observed 14.6 GiB, CID MID `0x15`, product name `AJTD4R`; 4-bit HPS SDMMC; VCC is 3.3 V and VCCQ/I/O is fixed at 1.8 V | Model separate `vmmc` 3.3 V and `vqmmc` 1.8 V supplies; non-removable, 4-bit MMC HS52 with a 50 MHz physical CIU limit; do not advertise HS200/HS400 |
