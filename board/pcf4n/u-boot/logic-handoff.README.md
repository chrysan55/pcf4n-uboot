...
contain `pcf4n-emmc4-hs52-dt50-uart1-dt`. TF-A selects HPS UART1 through the
...
and retains the remaining MMC/reset bring-up markers. No eMMC functional or
UART routing driver patch is applied in this stock-driver build.
